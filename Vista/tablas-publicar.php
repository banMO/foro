...
//$publicacion = new Publicacion('leticia','publicaciones','habilitado',$titulo,$fecha,$hora,1024,$ruta,TRUE,TRUE,$des);
	...
	echo $fechap;
	//echo $horap;		 
	$comentario_add = mysql_query("INSERT INTO registro (NOMBRE_U,TIPO_T,ESTADO_E,NOMBRE_R,FECHA_R,HORA_R) VALUES ('nombreUS','publicaciones','habilitado','$titulo','$fecha','$hora')")or
			die("Error al s");
